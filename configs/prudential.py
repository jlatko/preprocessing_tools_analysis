...
from transformers import BoxCoxTransformer, PolynomialsAdder, CustomBinner, OutliersClipper, FeatureProduct, \
    LabelsClipper, CustomBinaryBinner

baseline = {'DecisionTreeClassifier': {'params': {'predictor': LabelsClipper(regressor=DecisionTreeClassifier()),
   'scaler': RobustScaler(),
