...
def get_test_config_heart(missing=True):
    ...
    params = {'DecisionTreeClassifier_base': {'params': {'predictor': DecisionTreeClassifier(max_depth=None),
       'scaler': None,
     ...
     'KNeighborsClassifier_base': {'params': {'predictor': KNeighborsClassifier(n_neighbors=7
                                                                                # ,n_jobs=7
                                                                                )
         ,
       'scaler': RobustScaler(),
     ...
     'LogisticRegression_base': {'params': {'predictor': LogisticRegression(
         # n_jobs=7,
     ),
       'scaler': None,
       'simple_imputer': FillNaTransformer(from_dict={},
      ...
      # 'std': 0.04176646782554455},
        ...
        'DecisionTreeClassifier_best': {'params':
            {
        ...
        'LogisticRegression_best': {'params':
            {
                'binner2': None,
